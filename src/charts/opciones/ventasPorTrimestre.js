...
export function opcionVentasPorTrimestre(ventas) {
  return {
    title: { text: 'Ingresos, gastos y utilidad por trimestre', left: 'center', top: 8, textStyle: { fontSize: 14 } },
    tooltip: { trigger: 'axis' },
    legend: { data: ['Ingresos', 'Gastos', 'Utilidad'], top: 38 },
    grid: { left: 60, right: 24, top: 80, bottom: 32 },
